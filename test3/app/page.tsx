    ...
    <main className={styles.mainContainer}>
      ...
      <div className={styles.recommendedAppsContainer}>
        <div className={styles.recommendedApps}>
          <Link href="/Apps/name"><div className={styles.app1}>
            ...
            <div className={styles.horizontalOriA}>
              <div className={styles.verticalOriA}>
                ...
                <div className={styles.galleryA}>
                  ...
                  <img src="https://assets.onecompiler.app/42xjnjtme/439runy9u/460x0w%20(17).webp" />
              ...
              <div className={styles.together}>
                <div className={styles.appDemoPhoneA}><img src="https://assets.onecompiler.app/42xjnjtme/439pfatvu/460x0w%20(2).webp" /></div>
                <div className={styles.phoneAContainer}><img className={styles.phonePropA1} src="https://assets.onecompiler.app/42xjnjtme/439sca9ca/imageedit_6_9622755702.png" /></div>
              </div>
